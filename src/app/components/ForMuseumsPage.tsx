        ...
        <div className="relative max-w-[1280px] mx-auto px-6 lg:px-10 pt-20 md:pt-28 pb-20 md:pb-28">
          <div className="max-w-[600px]">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/contact" className="font-['Manrope'] text-[14px] px-7 py-3.5 rounded-full bg-[#ffe088] text-[#341701] hover:bg-[#f5d56e] transition-colors text-center">
                Book a Demo
              </Link>
              <Link to="/contact" className="font-['Manrope'] text-[14px] px-7 py-3.5 rounded-full border border-[#ffe088]/30 text-[#ffe088] hover:bg-[#ffe088]/10 transition-colors text-center">
                Become a Partner
              </Link>
            </div>
          </div>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {BENEFITS.map((b) => (
              <div key={b.title} className="bg-white rounded-2xl p-7 border border-[#c9a84c]/10 hover:shadow-[0_12px_40px_rgba(52,23,1,0.06)] transition-all duration-300">
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={s.step} className="bg-[#f5f0e4] rounded-2xl p-8 border border-[#c9a84c]/10 text-center">
      ...
      <section className="py-20 bg-[#341701]">
        <div className="max-w-[800px] mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link to="/contact" className="w-full sm:w-auto font-['Manrope'] text-[14px] px-8 py-4 rounded-full border border-[#ffe088]/30 text-[#ffe088] hover:bg-[#ffe088]/10 transition-colors text-center">
              Contact the Team
            </Link>
          </div>
        </div>
