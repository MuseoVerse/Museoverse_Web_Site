    ...
    >
      <div className="max-w-[1280px] mx-auto px-6 lg:px-10 flex items-center justify-between h-[72px]">
        ...
        <Link to="/" className="flex items-center gap-2.5 group">
          <div className="w-9 h-9 rounded-full bg-[#341701] flex items-center justify-center">
        ...
        <div className="hidden lg:flex items-center gap-8">
          {NAV_ITEMS.map((item) => (
            <Link
              key={item.path}
              to={item.path}
              className={`font-['Manrope'] text-[14px] tracking-[0.2px] transition-colors duration-200 ${
        ...
        <div className="hidden lg:flex items-center gap-3">
          <Link
            to="/contact"
            className="font-['Manrope'] text-[13px] tracking-[0.3px] px-5 py-2.5 rounded-full border border-[#c9a84c]/40 text-[#341701] hover:bg-[#341701] hover:text-[#fbf9f4] hover:border-[#341701] transition-all duration-300"
          >
            Book a Demo
          </Link>
          <Link
            to="/for-visitors"
            className="font-['Manrope'] text-[13px] tracking-[0.3px] px-5 py-2.5 rounded-full bg-[#341701] text-[#ffe088] hover:bg-[#4a2508] transition-all duration-300"
          >
            Download App
          </Link>
        </div>
      ...
      {/* Mobile Menu */}
      {mobileOpen && (
        <div className="lg:hidden bg-[#fbf9f4] border-t border-[#c9a84c]/20 px-6 pb-6 pt-4 space-y-1">
          {NAV_ITEMS.map((item) => (
            <Link
              key={item.path}
              to={item.path}
      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-10 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="#" className="flex items-center gap-3 bg-[#fbf9f4]/5 hover:bg-[#fbf9f4]/10 rounded-xl px-4 py-3 transition-colors group">
