...
import {
  ScanSearch, BookOpen, Sparkles, Users, Globe, Heart,
  ...
  return (
    <div>
      ...
      <section className="pt-[72px] relative overflow-hidden">
        ...
        <div className="absolute top-20 right-0 w-[400px] h-[400px] rounded-full bg-[#ffe088]/10 blur-[100px]" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 mb-8">
                <a href="#" className="flex items-center gap-3 bg-[#341701] rounded-xl px-5 py-3.5 hover:bg-[#4a2508] transition-colors">
            ...
            <div className="flex justify-center">
              <div className="relative">
                ...
                {/* Floating card */}
                <div className="absolute -left-8 bottom-24 bg-white rounded-xl p-4 shadow-[0_8px_32px_rgba(52,23,1,0.12)] border border-[#c9a84c]/10 hidden md:block">
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {APP_FEATURES.map((f) => (
              <div key={f.title} className="group bg-white rounded-2xl p-7 border border-[#c9a84c]/10 hover:border-[#c9a84c]/25 hover:shadow-[0_12px_40px_rgba(52,23,1,0.06)] transition-all duration-300">
      ...
      <section className="py-20 md:py-24 bg-[#341701] relative overflow-hidden">
        ...
        <div className="relative max-w-[800px] mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="#" className="flex items-center gap-3 bg-[#ffe088] rounded-xl px-6 py-4 hover:bg-[#f5d56e] transition-colors">
